...
Виконання команди:
```text
ivan@ivan-VirtualBox:~/PycharmProjects/pythonProject/Lab3$ sudo pipenv run python manage.py runserver
...
[09/Nov/2021 03:51:14] "GET / HTTP/1.1" 200 123
[09/Nov/2021 03:51:19] "GET / HTTP/1.1" 200 123
^Civan@ivan-VirtualBox:~/PycharmProjects/pythonProject/Lab3$
```
...
#### 15. Після успішного виконання роботи відредагував свій персональний `README.md` 